...
import '../controller/dental_clinic_subscription_controller.dart';

class DentalClinicSubscriptionView
    extends GetView<DentalClinicSubscriptionController> {
  const DentalClinicSubscriptionView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(DentalClinicSubscriptionController());
    return Scaffold(
      body: Container(
        height: 100.h,
        width: 100.w,
